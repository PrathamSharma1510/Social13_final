...
const SocialLogins = ({
  ...
  return (
    <div
      className={clsx(
        " mt-4 justify-content-center mb-3",
        login ? "d-flex flex-column align-items-center" : "row"
      )}
    >
      <button
        onClick={login ? loginGoogle : registerGoogle}
        className={clsx(" m-1 ", !login ? "col-md-5 register" : "Login")}
      >
        <img
          className="me-3 googleImg gl"
